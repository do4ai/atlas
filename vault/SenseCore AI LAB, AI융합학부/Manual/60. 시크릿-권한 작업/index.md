...
실수 시 영향 범위가 크므로 변경 이력과 검증 기준을 함께 남기는 것을 전제로 한다.

현재 운영 기준으로 먼저 볼 문서는 아래다.

- `Infisical 시크릿 반영과 권한 변경 절차`: 시크릿 소비 경로 확인, operator 반영 확인, 앱 기동 검증, 권한 최소화 기준

## Page Tree

- [Infisical 시크릿 반영과 권한 변경 절차](Infisical 시크릿 반영과 권한 변경 절차/index.md)
